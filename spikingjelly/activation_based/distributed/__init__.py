...
SNN 分布式训练模块。与 Megatron Core 相关的语言模型能力位于
...
Distributed SNN training modules. Language-model functionality backed by
Megatron Core lives in :mod:`spikingjelly.activation_based.distributed.llm`.
