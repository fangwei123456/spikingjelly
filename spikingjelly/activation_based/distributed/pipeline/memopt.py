...
def apply_pipeline_stage_memopt(
    ...
    *,
    ...
    if memopt_level <= 0:
        ...
        logger.info(
            "Distributed pipeline memory optimization completed: model_family={} applied={} memopt_level={} selected_stage_indices={} optimize_ms={} compress_x={}",
    ...
    logger.info(
        "Distributed pipeline memory optimization completed: model_family={} applied={} memopt_level={} selected_stage_indices={} optimize_ms={:.3f} compress_x={}",
        runtime.model_family,
        True,
        memopt_level,
        selected,
