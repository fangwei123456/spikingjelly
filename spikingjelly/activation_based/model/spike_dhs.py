...
OPS = {
    'skip_connect': lambda Cin,Cout, stride, signal: (SpikingConv2d(Cin, Cout, stride=stride, padding=1, spiking=False) if signal == 1 else Identity(Cin, Cout, signal)),
    'snn_b3': lambda Cin,Cout, stride, signal: SpikingConv2d(Cin, Cout, kernel_size=3, stride=stride, padding=1, spiking=False),
