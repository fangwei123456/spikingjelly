...
@register_op("sj::multistep_lif_mixed_precision_inference")
def multistep_lif_mixed_precision_inference_op(
    x_seq: torch.Tensor,
    v_init: torch.Tensor,
    decay_input: bool,
    tau: float,
    ...
    _check_mixed_precision_cuda_inputs(x_seq, v_init, "LIF")
...
@torch.library.register_fake("sj::multistep_lif_mixed_precision_inference")
def _multistep_lif_mixed_precision_inference_fake(
    x_seq: torch.Tensor,
    v_init: torch.Tensor,
    decay_input: bool,
    tau: float,
...
@register_op("sj::multistep_lif_mixed_precision_forward")
def multistep_lif_mixed_precision_forward_op(
    x_seq: torch.Tensor,
    v_init: torch.Tensor,
    decay_input: bool,
    tau: float,
...
@torch.library.register_fake("sj::multistep_lif_mixed_precision_forward")
def _multistep_lif_mixed_precision_forward_fake(
    x_seq: torch.Tensor,
    v_init: torch.Tensor,
    decay_input: bool,
    tau: float,
...
def multistep_lif_mixed_precision_forward_with_plan(
    x_seq: torch.Tensor,
    v_init: torch.Tensor,
    ...
    *,
    ...
    if torch.is_grad_enabled() and (x_seq.requires_grad or v_init.requires_grad):
        ...
        s_seq, v_seq, h_seq = multistep_lif_mixed_precision_forward_op(
            x_seq,
            v_init,
            decay_input,
            tau,
    ...
    s_seq, v_seq, h_seq = multistep_lif_mixed_precision_inference_op(
        x_seq,
        v_init,
        decay_input,
        tau,
...
def multistep_lif_mixed_precision_forward(
    ...
    *,
    ...
    return multistep_lif_mixed_precision_forward_with_plan(
        x_seq,
        v_init,
        plan,
        decay_input=decay_input,
...
def _setup_mixed_precision_lif_context(ctx, inputs, output):
    (
        x_seq,
        v_init,
        decay_input,
...
def _multistep_lif_mixed_precision_backward(ctx, grad_s_seq, grad_v_seq, grad_h_seq):
...
torch.library.register_autograd(
    "sj::multistep_lif_mixed_precision_forward",
    _multistep_lif_mixed_precision_backward,
    setup_context=_setup_mixed_precision_lif_context,
)
