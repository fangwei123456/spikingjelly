...
if __name__ == "__main__":
    ...
    plt.show()
    plt.savefig("./docs/source/_static/tutorials/stdp/mstdp.png")
    plt.savefig("./docs/source/_static/tutorials/stdp/mstdp.svg")
    plt.savefig("./docs/source/_static/tutorials/stdp/mstdp.pdf")
