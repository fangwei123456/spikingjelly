...
.. image:: ../../_static/tutorials/13_neuromorphic_datasets/dvsg.*
    :width: 100%
...
with fixed duration. Fortunately, we can use :class:`spikingjelly.datasets.utils.pad_sequence_collate` and
...
.. image:: ../../_static/tutorials/13_neuromorphic_datasets/dvsg2.*
    :width: 100%
