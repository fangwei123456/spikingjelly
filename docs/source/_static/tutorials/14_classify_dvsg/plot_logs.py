...
if __name__ == "__main__":
    ...
    plot_log(
        "./run-T_16_b_16_c_128_Adam_lr_0.001_CosALR_64_amp_cext_dvsg_logs-tag-test_acc.csv",
        "Test accuracy",
        "iteration",
        "accuracy",
    )
    ...
    plt.clf()
    plot_log(
        "./run-T_16_b_16_c_128_Adam_lr_0.001_CosALR_64_amp_cext_dvsg_logs-tag-test_loss.csv",
        "Test loss",
        "iteration",
        "accuracy",
    )
    ...
    plt.clf()
    plot_log(
        "./run-T_16_b_16_c_128_Adam_lr_0.001_CosALR_64_amp_cext_dvsg_logs-tag-train_acc.csv",
        "Train accuracy",
        "iteration",
        "accuracy",
    )
    ...
    plt.clf()
    plot_log(
        "./run-T_16_b_16_c_128_Adam_lr_0.001_CosALR_64_amp_cext_dvsg_logs-tag-train_loss.csv",
        "Train loss",
        "iteration",
        "accuracy",
    )
