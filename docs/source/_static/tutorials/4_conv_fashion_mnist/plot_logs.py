...
if __name__ == '__main__':
    ...
    plot_log('./docs/source/_static/tutorials/4_conv_fashion_mnist/run-logs-tag-train_accuracy.csv', 'Accuracy on train batch',
             'iteration', 'accuracy')
    ...
    plt.clf()
    plot_log('./docs/source/_static/tutorials/4_conv_fashion_mnist/run-logs-tag-test_accuracy.csv', 'Accuracy on test dataset',
