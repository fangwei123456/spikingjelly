...
csv_array = np.loadtxt('./docs/source/_static/tutorials/11_cext_neuron_with_lbl/exe_time.csv', delimiter=',', skiprows=1)
T = csv_array[:, 0]
T_str = []
...
plt.savefig('./docs/source/_static/tutorials/11_cext_neuron_with_lbl/exe_time_f.svg')
plt.savefig('./docs/source/_static/tutorials/11_cext_neuron_with_lbl/exe_time_f.pdf')
plt.savefig('./docs/source/_static/tutorials/11_cext_neuron_with_lbl/exe_time_f.png')
plt.clf()
...
plt.xticks(x, T_str)
plt.legend(frameon=True)
plt.savefig('./docs/source/_static/tutorials/11_cext_neuron_with_lbl/exe_time_fb.svg')
plt.savefig('./docs/source/_static/tutorials/11_cext_neuron_with_lbl/exe_time_fb.pdf')
plt.savefig('./docs/source/_static/tutorials/11_cext_neuron_with_lbl/exe_time_fb.png')